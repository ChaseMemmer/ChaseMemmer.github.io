...
var mouseObj = {
  ...
  manageMouseLeave: function(event) {
    event.currentTarget.style.boxShadow = "0 0 0 rgba(45, 95, 170,0.2)";
    // update btn gradient
    event.currentTarget.style.background = "rgb(45, 95, 170)";
  },
  ...
  manageButtonShadow: function(direction, target) {
    if (mouseObj.mouseCoords) {
      ...
      target.style.boxShadow = direction * mouseObj.mouseCoords.mouse_x + "px 10px 0 rgba(33,120,255,0.2)";
      
      // update btn gradient
      target.style.background = "radial-gradient(at "+mouseObj.mouseCoords.mouse_true_x+"px, rgb(100, 130, 160) 0%, rgb(45, 95, 170) 80%)";
